...
//console.log("Car 33 is a", inventory[32]);
...
let carModle = [];
inventory.forEach(cv => {
  carModle.push(cv.car_model);
  carModle.sort();
});

console.log(carModle);
